            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 text-left mb-4 mt-2">
                        <a href="{{ route('generate-links.index') }}" class="btn btn-primary">Вернуться </a>
                    </div>
                </div>

                <div class="row">
                    <form action="{{ route('generate-links.update' , $link->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link" class="form-control" placeholder="Источник"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="generated" class="form-control" placeholder="Сокращенная ссылка"
                                           value="{{ old('generated', $link->generated) }}">
                                </div>
                            </div>

                            <div class="col-xs-12 col-sm-12 col-md-12 text-center mb-4 mt-2">
                                <button type="submit" class="btn btn-primary">Обновить ссылку</button>
                            </div>
                        </div>
                    </form>
                </div>
